...
type OrderManagement_UpdateOrdersClient interface {
	Send(*Order) error
	CloseAndRecv() (*protobuf.StringValue, error)
	grpc.ClientStream
}
...
func (x *orderManagementUpdateOrdersClient) CloseAndRecv() (*protobuf.StringValue, error) {
...
type OrderManagement_UpdateOrdersServer interface {
	SendAndClose(*protobuf.StringValue) error
	Recv() (*Order, error)
	grpc.ServerStream
}
...
func (x *orderManagementUpdateOrdersServer) SendAndClose(m *protobuf.StringValue) error {
