...
var file_ordermanagement_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x32, 0x61, 0x0a, 0x0f, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x4e, 0x0a,
...
var file_ordermanagement_proto_goTypes = []interface{}{
	...
	(*protobuf.StringValue)(nil), // 2: google.protobuf.StringValue
}
...
type OrderManagement_ProcessOrdersClient interface {
	Send(*protobuf.StringValue) error
...
func (x *orderManagementProcessOrdersClient) Send(m *protobuf.StringValue) error {
...
type OrderManagement_ProcessOrdersServer interface {
	...
	Recv() (*protobuf.StringValue, error)
	grpc.ServerStream
}
...
func (x *orderManagementProcessOrdersServer) Recv() (*protobuf.StringValue, error) {
