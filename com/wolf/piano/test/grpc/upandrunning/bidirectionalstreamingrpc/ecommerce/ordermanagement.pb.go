...
func (x *CombinedShipment) Reset() {
	*x = CombinedShipment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ordermanagement_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CombinedShipment) Descriptor() ([]byte, []int) {
	return file_ordermanagement_proto_rawDescGZIP(), []int{2}
}
...
var file_ordermanagement_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x22, 0x26, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x05, 0x4f,
	...
	0x73, 0x74, 0x32, 0x5a, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x47, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x15, 0x2e, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72,
	0x63, 0x65, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x1a, 0x1b, 0x2e,
	0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x2e, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e,
	0x65, 0x64, 0x53, 0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06,
...
var file_ordermanagement_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_ordermanagement_proto_goTypes = []interface{}{
	(*OrderReply)(nil),       // 0: ecommerce.OrderReply
...
var file_ordermanagement_proto_depIdxs = []int32{
	...
	0, // 1: ecommerce.OrderManagement.processOrders:input_type -> ecommerce.OrderReply
	2, // 2: ecommerce.OrderManagement.processOrders:output_type -> ecommerce.CombinedShipment
...
func file_ordermanagement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ordermanagement_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
...
func (x *orderManagementProcessOrdersClient) Send(m *OrderReply) error {
...
func (x *orderManagementProcessOrdersServer) Recv() (*OrderReply, error) {
	m := new(OrderReply)
