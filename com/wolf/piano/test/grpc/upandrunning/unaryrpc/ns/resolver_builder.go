...
// 其中 ns 为协议名，callerService 为订阅方服务名（consumer），calleeService 为发布方服务名（provider）
...
func (*nsResolverBuilder) Build(target resolver.Target, cc resolver.ClientConn, opts resolver.BuildOptions) (resolver.Resolver, error) {
